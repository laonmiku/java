	    ...
	    while(run) {
	        ...
	        case "4" : //삭제
	        	...
	        	if(vo4.getPcode()==null) {
	        		...
	        		System.out.println(vo4.getPcode()+"교수를 삭제하실래요?(y)");
